...
";
        ...
        static void Gameplay(List<kerdesek> questions)
        {
            ...
            { 
                if (k.KerdesTipus == "I/H")
                {
                    Console.Write($"{k.KerdesLeiras}\n\t{k.Valasz1}\t{k.Valasz2}\n");
                    int myanswer = int.Parse(Console.ReadLine());
                    if (myanswer == k.HelyesValasz)
                    {
                        correct++;
                    ...
                    else
                    {
                        if (1 == k.HelyesValasz)
                        {
                            Console.WriteLine($"Helytelen!\nA helyes válasz {k.Valasz2}");
                            Console.ReadLine();
                            Console.Clear();
                        }
                        else
                        {
                            Console.WriteLine($"Helytelen!\nA helyes válasz {k.Valasz1}");
                            Console.ReadLine();
                            Console.Clear();
                        }
                    }
                ...
                else
                {
                    ...
                    {
                        Console.WriteLine($"Helytelen!\nA helyes válasz sorszáma: {k.HelyesValasz}");
                        Console.ReadLine();
                        Console.Clear();
                    }
                }
            }
            Console.WriteLine("A teljesítményed: "+ correct+"/"+questions.Count());

            string answer;
            do
            {
                Console.Write("Szeretnéd-e újrapróbálni a kvízt (I/H)?\n");
                answer = Console.ReadLine().ToUpper();
                Console.Clear();
            }
            while (answer != "I" && answer != "H");
            ...
            else
            {
                ...
                do
                {
                    Console.Write("Szeretnél-e teljesen új játékot indítani? (I/H)\n");
                    answer2 = Console.ReadLine().ToUpper();
                    Console.Clear();
                }
                while (answer2 != "I" && answer2 != "H");
                ...
                {
                    Console.WriteLine("Ezzel befejezted a játékot!");
                    Console.ReadLine();
                }
            }
        }
